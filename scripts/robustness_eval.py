...
from echo_research.inference import binary_inference_options, binary_masks_from_logits
...
def main():
    ...
    _,_,test_ids=split_ids_from_config(cfg); verify_run_split(args.checkpoint,"test",test_ids,required=True)
    ...
    for batch in loader:
        ...
        for kind in ["clean"]+KINDS:
            ...
            for sev in sevs:
                ...
                pred=binary_masks_from_logits(model.generator(x),threshold,keep_largest,fill_holes)
